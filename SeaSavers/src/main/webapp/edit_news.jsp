...
<head>
<meta charset="UTF-8">
<title>Sea Savers - Editar Noticias</title>
...
<!-- Fin CSS del footer -->
<!-- Inicio CSS del main -->
<link rel="stylesheet" href="css/edit_news_style.css">
<!-- Fin CSS del main -->
</head>
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12"> <!-- Ajusta el tamaño del contenedor de las noticias -->
            ...
            String noticias = noticia.consultarTodoAdmin();
    ...
    <div class="text-center mt-4">
        <!-- Este div envuelve al botón de "volver" -->
        <a href="home_admin.jsp" class="btn btn-secondary">Volver</a>
    </div>
    
    <div class="text-center mt-4">
        <!-- Este div envuelve al botón de "insertar noticia" -->
        <a href="insert_news.jsp" class="btn btn-primary btn-insert-news">Insertar Noticia</a>
    </div>
</main>

...
<body>
	...
	<main>
        ...
        <h2 class="text-center mb-4">Menú de Opciones</h2>
        <div class="row justify-content-center mt-5">
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        <i class="fas fa-edit fa-3x mb-3"></i>
                        <h5 class="card-title">Editar Recursos</h5>
                        <a href="edit_resources.jsp" class="btn btn-primary mt-3">Ir a Editar Recursos</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Editar Noticias</h5>
                        <a href="edit_news.jsp" class="btn btn-primary mt-3">Ir a Editar Noticias</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Añadir Administrador</h5>
                        <a href="add_admin.jsp" class="btn btn-primary mt-3">Ir a Añadir Administrador</a>
                    </div>
                </div>
            </div>
        </div>
